...
class Settings(BaseSettings):
    ...
    # 心跳配置
    HEARTBEAT_INTERVAL: float = Field(default=1.0, description="心跳更新间隔（秒），建议小于超时时间的一半")
    ...
    REG_INPUT_ENCODER_Z_STATE: int = Field(default=5013, description="编码器Z信号状态，1=已找到，0=未找到")
